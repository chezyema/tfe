...
public class EcoleControlleur {
     public static void estValide(Ecole ecole) throws ValidationException{
        ...
        if(ecole.getCdpostal() == 0 || CodePosalValidation.checkCodePostale(null)){
        ...
        if(ecole.getTelecole() == 0 || NumTelValidation.checkNumTel(null)){
        ...
        if(ecole.getAnneescolaire() == null || StringValidation.VerifString(ecole.getAnneescolaire())){
                throw new ValidationException("Le nom du directeur de l'ecole n'est pas valide");
        }
        }
     }
